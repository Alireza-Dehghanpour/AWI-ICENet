...
path="/albedo/work/user/aldehg001/Data/All_mission/DNN/DNN_INPUT_S3A_PLRM_SIM_1000_40_95_FLOOR/"
...
def create_cnn_model():
 ...
 # ------------------------------Block 6-------------------------------
  ...
  output = keras.layers.Dense(1,activation="relu")(fc2)
...
np.save(path+"history_DNN_INPUT_S3A_PLRM_SIM_1000_40_95_FLOOR_2dens_2e-5.npy", hist_CNN.history)

CNN_model.save(path+'DCNN_DNN_INPUT_S3A_PLRM_SIM_1000_40_95_FLOOR_2dens_2e-5.h5')
