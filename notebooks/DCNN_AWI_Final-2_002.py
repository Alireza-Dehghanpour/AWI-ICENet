...
path="/albedo/work/user/aldehg001/Data/All_mission/DNN/DNN_INPUT_ERS1O_SIM_1000_40_95_FLOOR/"
...
def create_cnn_model():
 ...
 # ------------------------------Block 5-------------------------------
  ...
  x=keras.layers.Activation("relu")(x)
  x=keras.layers.BatchNormalization()(x)
  x = keras.layers.MaxPooling1D((2), strides=(1), name='block5_pool')(x)
  x = keras.layers.Dropout(0.25)(x)
  flatten = keras.layers.Flatten()(x)
  fc1 = keras.layers.Dense(64, activation='relu')(flatten)
#  fc2 = keras.layers.Dense(64, activation='relu')(fc1)
  #____________________________________________________________
  output = keras.layers.Dense(1,activation="relu")(fc1)
...
np.save(path+"history_ERS1O_SIM__40_95_2e-4_2dense.npy", hist_CNN.history)

CNN_model.save(path+'DCNN_ERS1O_SIM__1000_40_95_2e-4_2dens.h5')
